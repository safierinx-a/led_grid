...
class GenerativeArt(Pattern):
    ...
    def generate_frame(self, params: Dict[str, Any]) -> List[Dict[str, int]]:
        ...
        if variation == "flow_field":
            pattern_pixels = self._generate_flow_field(params)
        elif variation == "voronoi":
            pattern_pixels = self._generate_voronoi(params)
        elif variation == "maze":
            pattern_pixels = self._generate_maze(params)
        elif variation == "fractal":
            pattern_pixels = self._generate_fractal(params)
